...
function listar() {
    $.ajax({
        ...
        url: "https://ge87fc5530be4b4-db202110011129.adb.ca-montreal-1.oraclecloudapps.com/ords/admin/open-api-catalog/message/",
...
function listarRespuesta(items) {
    ...
    <thead>
                  <tr>
                    <th><span class="yellow">Cliente</span></th>
                    <th><span class="yellow">Cabaña</span></th>
                    <th><span class="yellow">Mensaje</span></th>
    ...
    for (var i=0; i < items.length; i++) {
        tabla +=`<tr>
                   <td><span class="yellow">${items[i].client.name}</span</td> 
                   <td><span class="yellow">${items[i].costume.name}</span</td> 
                   <td><span class="yellow">${items[i].messageText}</span</td>
                   <td><div id="neon-btn"><button onclick="mostrarmensaje()" class="btn one">Editar</button></div></td>
                   <td><button onclick="mostrarmensaje()" class="btn three">Borrar</button></td>
                   </tr>`;
    }
