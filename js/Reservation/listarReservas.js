...
function listar() {
    $.ajax({
        ...
        url: "http://localhost:8081/api/Reservationtion/all",
...
function listarRespuesta(items) {
	...
	<thead>
                  <tr>
                    <th>Cliente</th>
                    <th>Reservation desde:</th>
                    <th>Reservation Hasta:</th>
    ...
    for (var i=0; i < items.length; i++) {
        ...
        <td><span class="yellow">${items[i].Reservation}</span></td>
       <td><div id="neon-btn"><button onclick="editarReservation(${items[i].id})" class="btn one">Editar</button></div></td>
