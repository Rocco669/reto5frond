...
function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "https://ge87fc5530be4b4-db202110011129.adb.ca-montreal-1.oraclecloudapps.com/ords/admin/client/client/" + llaveRegistro,
...
function editarRespuesta(items) {
    ...
    $("#ReservationEdit").val(items[0].Reservation);
}
...
function actualizar() {
    ...
    let datos = {
        id: $("#idEdit").val(),
        Reservation: $("#ReservationEdit").val()
    }
